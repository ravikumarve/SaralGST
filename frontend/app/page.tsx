  ...
  return (
    <>
          ...
          <BentoGrid>
              ...
              <div className="search-ui">
                ...
                <div className="live-result">
                  <div>
                    ...
                    <div className="mono text-[#a1a1aa]">
                      HSN Code: 8528
                    </div>
            ...
            <div className="bento-box col-span-12 md:col-span-4 row-span-2">
              ...
              <div className="mt-auto pt-4 border-t border-[#262626] flex justify-between items-center">
                ...
                <span className="text-[#10b981] text-3xl font-bold">
                  18%
                </span>
              </div>
            </div>
      ...
      <section id="pricing" className="py-24">
        <div className="max-w-[1280px] mx-auto px-8">
          <div className="section-header text-center" style={{ margin: '0 auto', textAlign: 'center' }}>
            <h2>
          ...
          <div className="pricing-cards">
            ...
            <div className="price-tier popular">
              <div
                className="mono text-[#8a2be2] text-xs uppercase tracking-wider font-bold mb-4"
              >
                Production Ready
              </div>
      ...
      {/* ===== Footer ===== */}
      <footer className="border-t border-[#262626] py-16 mt-16 bg-[#050505]">
        <div className="max-w-[1280px] mx-auto px-8">
          <div className="footer-grid">
            {/* Brand */}
            <div>
              <div
                className="flex items-center gap-3 font-space-grotesk font-bold text-lg text-[#ededed] mb-4"
              >
          ...
          <div className="border-t border-[#262626] pt-6 mt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="mono text-[#10b981]">
              ● Systems Nominal
            </div>
          </div>
        </div>
